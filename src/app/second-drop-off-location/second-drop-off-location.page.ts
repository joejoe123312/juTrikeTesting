...
export class SecondDropOffLocationPage implements OnInit {
 ...
 async SelectSearchResult(item) {
   ...
   this.mapsService.updateSecondDropOffLocation(this.latitude, this.longitude, this.pickUpLocation);
 ...
 async confirmLocation(){
   ...
   await this.mapsService.getAddressfromLatLong(this.lat, this.long).subscribe(observedValue => {
     ...
     this.mapsService.updateSecondDropOffLocation(this.lat, this.long, this.address);
